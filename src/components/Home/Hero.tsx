...
const Hero = () => {
    return (
        <section id="Hero" className="relative h-screen">
            <div
                className={`absolute inset-0 top-[10%]  max-w-7xl mx-auto sm:px-16 px-6 flex flex-row items-start gap-5 md:top-[250px]`}
            >
            ...
            <ComputerCanvas />
            <div className="absolute bottom-[20%] md:bottom-[13%] w-full flex justify-center items-center">
                <a href="#about">
